...
> — Reglamento de Radiocomunicaciones de la UIT, artículo 1, definición 1.56
...
1. **Examen** → **diploma de operador de estación de aficionado** (con certificado **HAREC** europeo incluido). Dos pruebas tipo test de 30 preguntas (electricidad/radioelectricidad y normativa), 15 aciertos para aprobar cada una, 90 minutos, por ordenador en las Jefaturas Provinciales de Inspección de Telecomunicaciones. Regulado en el artículo 10 del Reglamento (Orden IET/1311/2013).
